...
* Maybe an insert of close-up ([issue #2](https://github.com/jlehtoma/validityms/issues/2))
* 3 panels with contrast ([issue #3](https://github.com/jlehtoma/validityms/issues/3))
