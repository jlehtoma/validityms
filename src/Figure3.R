...
p1 <- plot(variant.4, monochrome=TRUE, groups=TRUE, labels=spp.labels, 
...
variant.11 <- getVariant(project.130301, 11)
p2 <- plot(variant.11, monochrome=TRUE, groups=TRUE, labels=fert.labels, 
