...
ggplot(x.melt, aes(x = value, y = F.lost, col = variable, linetype = variable)) +
  geom_line(lwd = 1) +
  scale_linetype_manual(values = c(rep("solid", 2), rep("dashed", 3))) +
  scale_color_manual(values = c(brewer.pal(2, "Set3"), brewer.pal(3, "Set3"))) +
  opts(title = "BC mortality") +
  theme_bw()
